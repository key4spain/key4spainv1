...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://key4spain.com/barcelona",
  },
  title: "Barcelona Property Advisory & Relocation Support | Key4Spain",
  description:
    "Key4Spain helps international clients explore Barcelona with structured property advisory, relocation coordination, investment perspective, and trusted local referrals before major decisions.",
  openGraph: {
    type: "website",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Barcelona Property Advisory & Relocation Support — Key4Spain",
      },
    ],
  },
  twitter: {
...
const pageSchema: Record<string, unknown> = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://key4spain.com/barcelona#webpage",
      url: "https://key4spain.com/barcelona",
      name: "Barcelona Property Advisory & Relocation Support",
      description:
        "Key4Spain helps international clients explore Barcelona with structured property advisory, relocation coordination, investment perspective, and trusted local referrals before major decisions.",
      isPartOf: { "@id": "https://key4spain.com/#website" },
      about: { "@id": "https://key4spain.com/barcelona#service" },
      provider: { "@id": "https://key4spain.com/#organization" },
      inLanguage: "en",
    },
    {
      "@type": "Service",
      "@id": "https://key4spain.com/barcelona#service",
      name: "Property Advisory and Relocation Coordination in Barcelona",
      serviceType: "Property Advisory and Relocation Coordination",
      url: "https://key4spain.com/barcelona",
      provider: { "@id": "https://key4spain.com/#organization" },
      areaServed: ["Spain", "Barcelona"],
      availableLanguage: ["English", "Spanish", "Serbian"],
      description:
        "Structured property advisory, relocation coordination, investment perspective, documentation preparation, and professional referral coordination for international clients exploring Barcelona.",
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://key4spain.com/barcelona#breadcrumb",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Home", item: "https://key4spain.com" },
        { "@type": "ListItem", position: 2, name: "Barcelona", item: "https://key4spain.com/barcelona" },
      ],
    },
  ],
};
...
const clientTypes = [
  "International buyers purchasing property in Barcelona for the first time",
  "Families relocating to Barcelona who need area, school, and lifestyle questions structured",
  "Remote workers and entrepreneurs establishing a base in the city",
  "Investors evaluating property opportunities in Barcelona with a structured approach",
  "Clients comparing multiple Spanish cities and needing clear context for each before deciding",
  "Clients navigating Barcelona's high-information search environment who need structure before committing",
...
const processSteps = [
  {
    ...
    desc: "Share your interest in Barcelona, property goals, intended use, timeline, budget range if you choose, and any specific concerns or questions about the city.",
  },
  {
    n: "2",
    title: "Key4Spain reviews your brief",
    desc: "Your brief is reviewed and assessed. A structured response is prepared based on your situation and the specific questions you have about Barcelona.",
  },
  {
    n: "3",
      ...
      <main>
        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto px-6 py-20 md:py-28">
            ...
            >
              Property advisory and relocation coordination for international clients exploring Barcelona.
            </h1>
            <p
              className="text-muted leading-relaxed mb-10 max-w-[560px]"
              style={{ fontSize: "clamp(0.9rem, 1.4vw, 1.0625rem)" }}
            >
              Barcelona attracts international clients with complex property, relocation,
              and lifestyle questions. Key4Spain helps structure the early-stage process
              before decisions become expensive or difficult to reverse.
            </p>
          ...
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
              <div>
                ...
                >
                  Barcelona rewards structured exploration — not reactive search.
                </h2>
                <div className="space-y-5">
                  ...
                  >
                    Barcelona is one of Spain&apos;s most internationally visible cities,
                    which means the volume of information available to buyers, investors,
                    and relocators is large — and often conflicting. Online listings,
                    expat forums, and general media coverage rarely provide the
                    structured context needed to make good early-stage decisions.
                  </p>
                  <p
                    className="text-base md:text-lg leading-relaxed"
                    style={{ color: "rgba(7,17,31,0.65)" }}
                  >
                    The pace and international reach of Barcelona&apos;s property
                    environment means clients who arrive without a structured approach
                    frequently encounter confusion around search priorities, area fit,
                    professional referrals, and the right sequence of decisions. Time
                    is spent on the wrong steps — and by the time professional input is
                    sought, options may have narrowed unnecessarily.
                  </p>
                  <p
                    className="text-base md:text-lg leading-relaxed"
                    style={{ color: "rgba(7,17,31,0.65)" }}
                  >
                    Key4Spain helps clients approaching Barcelona ask better questions
                    before committing time, money, or expectations to an unstructured
                    search. The service covers the preparation and coordination
                    stages — property search structure, relocation planning, area
                    context, and the identification of when and where professional
                    input is required.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                {[
                  ...
                  "Relocation and lifestyle questions organized in advance",
        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="mb-16">
              ...
              >
                What Key4Spain can help coordinate in Barcelona.
              </h2>
            </div>
          ...
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
              <div>
                ...
                >
                  International clients exploring Barcelona with serious intent.
                </h2>
              ...
              <div className="flex flex-col gap-6 lg:pt-[68px]">
                ...
                >
                  ...
                  >
                    ...
                    international clients exploring Barcelona, with expanding coordination
                    across Valencia, Madrid, and selected Spanish coastal regions.
                  </p>
                  <ul className="space-y-3">
                    {["Barcelona", "Valencia", "Madrid", "Selected Spanish coastal regions"].map(
                      (area) => (
                        <li
                          key={area}
              ...
              <div>
                ...
                <div className="space-y-5 text-muted leading-relaxed">
                  <p className="text-base md:text-lg">
                    The Buyer &amp; Property Brief asks about your interest in Barcelona,
        ...
        {/* Services connected to Barcelona */}
        <section
          className="relative py-24 md:py-32"
          style={{
            background:
        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="mb-14">
              ...
              >
                Services connected to Barcelona coordination.
              </h2>
            </div>
          ...
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
              <div>
                ...
                >
                  Ready to approach Barcelona with a clearer plan?
                </h2>
                <p className="text-base text-muted leading-relaxed mb-4">
                  Start with the Buyer &amp; Property Brief. Share your interest in
                  Barcelona, your goals, and any concerns. Key4Spain will review your
